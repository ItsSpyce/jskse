...
pub fn begin(name: &str, open: *mut bool, flags: ImGuiWindowFlags) -> bool {
    ...
    unsafe { rimgui::Begin(&name, open, flags as i32) }
}
...
pub fn set_next_window_size(size: ImVec2, cond: Option<ImGuiCond>) {
    rimgui::SetNextWindowSize(&size.to_vec(), to_flag!(cond, ImGuiCond::None))
}

pub fn set_next_window_size_constraints(size_min: ImVec2, size_max: ImVec2) {
    rimgui::SetNextWindowSizeConstraints(&size_min.to_vec(), &size_max.to_vec())
}

pub fn set_next_window_content_size(size: ImVec2) {
    rimgui::SetNextWindowContentSize(&size.to_vec())
}

pub fn set_next_window_collapsed(collapsed: bool, cond: Option<ImGuiCond>) {
    rimgui::SetNextWindowCollapsed(collapsed, to_flag!(cond, ImGuiCond::None))
}

pub fn set_next_window_focus() {
    rimgui::SetNextWindowFocus()
}

pub fn set_next_window_bg_alpha(alpha: f32) {
    rimgui::SetNextWindowBgAlpha(alpha)
}

pub fn set_window_pos(pos: ImVec2, cond: Option<ImGuiCond>) {
    rimgui::SetWindowPos(&pos.to_vec(), to_flag!(cond, ImGuiCond::None))
}

pub fn set_window_size(size: ImVec2, cond: Option<ImGuiCond>) {
    rimgui::SetWindowSize(&size.to_vec(), to_flag!(cond, ImGuiCond::None))
}

pub fn set_window_collapsed(collapsed: bool, cond: Option<ImGuiCond>) {
    rimgui::SetWindowCollapsed(collapsed, to_flag!(cond, ImGuiCond::None))
}

pub fn set_window_focus() {
    rimgui::SetWindowFocus()
}

pub fn set_window_font_scale(scale: f32) {
    rimgui::SetWindowFontScale(scale)
}

pub fn set_window_pos_by_name(name: &str, pos: ImVec2, cond: Option<ImGuiCond>) {
    cxx::let_cxx_string!(name = name);
    rimgui::SetWindowPosByName(&name, &pos.to_vec(), to_flag!(cond, ImGuiCond::None))
}

pub fn set_window_size_by_name(name: &str, size: ImVec2, cond: Option<ImGuiCond>) {
    cxx::let_cxx_string!(name = name);
    rimgui::SetWindowSizeByName(&name, &size.to_vec(), to_flag!(cond, ImGuiCond::None))
}

pub fn set_window_collapsed_by_name(name: &str, collapsed: bool, cond: Option<ImGuiCond>) {
    cxx::let_cxx_string!(name = name);
    rimgui::SetWindowCollapsedByName(&name, collapsed, to_flag!(cond, ImGuiCond::None))
}

pub fn set_window_focus_by_name(name: &str) {
    cxx::let_cxx_string!(name = name);
    rimgui::SetWindowFocusByName(&name)
}

pub fn get_scroll() -> ImVec2 {
    ImVec2::new([rimgui::GetScrollX(), rimgui::GetScrollY()])
}
...
pub fn set_scroll(scroll: ImVec2) {
    rimgui::SetScrollX(scroll.x);
    rimgui::SetScrollY(scroll.y);
}

pub fn set_scroll_x(scroll_x: f32) {
    rimgui::SetScrollX(scroll_x)
}

pub fn set_scroll_y(scroll_y: f32) {
    rimgui::SetScrollY(scroll_y)
}

pub fn get_scroll_max_x() -> f32 {
    rimgui::GetScrollMaxX()
}

pub fn get_scroll_max_y() -> f32 {
    rimgui::GetScrollMaxY()
}

pub fn set_scroll_here_x(center_x_ratio: Option<f32>) {
    rimgui::SetScrollHereX(center_x_ratio.unwrap_or(0.5))
}

pub fn set_scroll_here_y(center_y_ratio: Option<f32>) {
    rimgui::SetScrollHereY(center_y_ratio.unwrap_or(0.5))
}

pub fn set_scroll_from_pos_x(pos_x: f32, center_x_ratio: Option<f32>) {
    rimgui::SetScrollFromPosX(pos_x, center_x_ratio.unwrap_or(0.5))
}

pub fn set_scroll_from_pos_y(pos_y: f32, center_y_ratio: Option<f32>) {
    rimgui::SetScrollFromPosY(pos_y, center_y_ratio.unwrap_or(0.5))
}
...
pub fn push_style_color(idx: ImGuiCol, col: ImColor4) {
    rimgui::PushStyleColor(to_flag!(idx), &col.to_vec())
}

pub fn pop_style_color(count: Option<i32>) {
    rimgui::PopStyleColor(count.unwrap_or(1))
}

pub fn push_style_var_float(idx: ImGuiStyleVar, val: f32) {
    rimgui::PushStyleVar(to_flag!(idx), &[val, -1.0])
}

pub fn push_style_var_vec(idx: ImGuiStyleVar, val: ImVec2) {
    rimgui::PushStyleVar(to_flag!(idx), &val.to_vec())
}

pub fn pop_style_var(count: Option<i32>) {
    rimgui::PopStyleVar(count.unwrap_or(1))
}

pub fn push_item_width(item_width: f32) {
    rimgui::PushItemWidth(item_width)
}
...
pub fn set_next_item_width(item_width: f32) {
    rimgui::SetNextItemWidth(item_width)
}

pub fn calc_item_width() -> f32 {
    rimgui::CalcItemWidth()
}

pub fn push_text_wrap_pos(wrap_pos_x: Option<f32>) {
    rimgui::PushTextWrapPos(wrap_pos_x.unwrap_or(0.0))
}

pub fn pop_text_wrap_pos() {
    rimgui::PopTextWrapPos()
}
...
pub fn get_font_tex_uv_white_pixel() -> ImVec2 {
    ImVec2::new(rimgui::GetFontTextUvWhitePixel())
}

pub fn get_color_u32(col: ImVec4) -> u32 {
    rimgui::GetColorU32(&col.to_vec())
}

pub fn get_color_u32_from_style(idx: ImGuiCol, alpha_mul: Option<f32>) -> u32 {
    rimgui::GetColorU32FromStyle(to_flag!(idx), alpha_mul.unwrap_or(1.0))
}

pub fn get_style_color_vec4(idx: ImGuiCol) -> ImVec4 {
    ImVec4::new(rimgui::GetStyleColorVec4(to_flag!(idx)))
}
...
pub fn same_line(offset_from_start_x: Option<f32>, spacing: Option<f32>) {
    rimgui::SameLine(offset_from_start_x.unwrap_or(0.0), spacing.unwrap_or(-1.0))
}
...
pub fn dummy(size: ImVec2) {
    rimgui::Dummy(&size.to_vec())
}

pub fn indent(index_w: Option<f32>) {
    rimgui::Indent(index_w.unwrap_or(0.0))
}

pub fn unindent(index_w: Option<f32>) {
    rimgui::Unindent(index_w.unwrap_or(0.0))
}
...
pub fn combo(label: &str, current_item: *mut i32, items: Vec<&str>, height_in_items: i32) -> bool {
    ...
    unsafe { rimgui::Combo(&label, current_item, &items, height_in_items) }
}
...
pub fn input_int2(label: &str, v: *mut [i32; 2], flags: Option<ImGuiInputTextFlags>) -> bool {
    cxx::let_cxx_string!(label = label);
    unsafe { rimgui::InputInt2(&label, v, to_flag!(flags, ImGuiInputTextFlags::None)) }
}

pub fn input_int3(label: &str, v: *mut [i32; 3], flags: Option<ImGuiInputTextFlags>) -> bool {
    cxx::let_cxx_string!(label = label);
    unsafe { rimgui::InputInt3(&label, v, to_flag!(flags, ImGuiInputTextFlags::None)) }
}

pub fn input_int4(label: &str, v: *mut [i32; 4], flags: Option<ImGuiInputTextFlags>) -> bool {
    cxx::let_cxx_string!(label = label);
    unsafe { rimgui::InputInt4(&label, v, to_flag!(flags, ImGuiInputTextFlags::None)) }
}
...
pub fn color_edit3(label: &str, col: &mut ImColor, flags: Option<ImGuiColorEditFlags>) -> bool {
    cxx::let_cxx_string!(label = label);
    unsafe {
        rimgui::ColorEdit3(
            &label,
...
pub fn color_edit4(label: &str, col: &mut ImColor4, flags: Option<ImGuiColorEditFlags>) -> bool {
    cxx::let_cxx_string!(label = label);
    unsafe {
        rimgui::ColorEdit4(
            &label,
...
pub fn color_picker3(label: &str, col: &mut ImColor, flags: Option<ImGuiColorEditFlags>) -> bool {
    cxx::let_cxx_string!(label = label);
    unsafe {
        rimgui::ColorPicker3(
            &label,
...
pub fn get_tree_node_to_label_spacing() -> f32 {
    rimgui::GetTreeNodeToLabelSpacing()
}

pub fn collapsing_header(label: &str, flags: Option<ImGuiTreeNodeFlags>) -> bool {
    cxx::let_cxx_string!(label = label);
    rimgui::CollapsingHeader(&label, to_flag!(flags, ImGuiTreeNodeFlags::None))
}
...
pub fn collapsing_header_ctrl(
    ...
    cxx::let_cxx_string!(label = label);
    unsafe { rimgui::CollapsingHeaderCtrl(&label, open, to_flag!(flags, ImGuiTreeNodeFlags::None)) }
}

pub fn set_next_item_open(is_open: bool, cond: Option<ImGuiCond>) {
    rimgui::SetNextItemOpen(is_open, to_flag!(cond, ImGuiCond::None))
}
...
pub fn list_box(
    ...
    cxx::let_cxx_string!(label = label);
    let items = items.iter().map(|s| s.to_string()).collect();
    unsafe { rimgui::ListBox(&label, current_item, &items, height_in_items) }
}

pub fn begin_main_menu_bar() -> bool {
    rimgui::BeginMainMenuBar()
}

pub fn end_main_menu_bar() {
    rimgui::EndMainMenuBar()
}
...
pub fn begin_menu(label: &str, enabled: bool) -> bool {
    cxx::let_cxx_string!(label = label);
    rimgui::BeginMenu(&label, enabled)
}
...
pub fn menu_item(label: &str, shortcut: Option<&str>, selected: bool, enabled: bool) -> bool {
    ...
    rimgui::MenuItem(&label, &shortcut, selected, enabled)
}
...
pub fn set_tooltip(fmt: &str, _args: Vec<&str>) {
    cxx::let_cxx_string!(fmt = fmt);
    rimgui::SetTooltip(&fmt)
}

pub fn begin_popup(str_id: &str, flags: Option<ImGuiWindowFlags>) -> bool {
    cxx::let_cxx_string!(str_id = str_id);
    rimgui::BeginPopup(&str_id, to_flag!(flags, ImGuiWindowFlags::None))
}

pub fn begin_popup_modal(name: &str, open: *mut bool, flags: Option<ImGuiWindowFlags>) -> bool {
    cxx::let_cxx_string!(name = name);
    unsafe { rimgui::BeginPopupModal(&name, open, to_flag!(flags, ImGuiWindowFlags::None)) }
}
...
pub fn open_popup_on_item_click(str_id: &str, flags: Option<ImGuiPopupFlags>) {
    cxx::let_cxx_string!(str_id = str_id);
    rimgui::OpenPopupOnItemClick(&str_id, to_flag!(flags, ImGuiPopupFlags::MouseButtonRight))
}

pub fn close_current_popup() {
    rimgui::CloseCurrentPopup()
}

pub fn begin_popup_context_item(str_id: &str, flags: Option<ImGuiPopupFlags>) -> bool {
    cxx::let_cxx_string!(str_id = str_id);
    rimgui::BeginPopupContextItem(&str_id, to_flag!(flags, ImGuiPopupFlags::MouseButtonRight))
}

pub fn begin_popup_context_window(str_id: &str, flags: Option<ImGuiPopupFlags>) -> bool {
    cxx::let_cxx_string!(str_id = str_id);
    rimgui::BeginPopupContextWindow(&str_id, to_flag!(flags, ImGuiPopupFlags::MouseButtonRight))
}

pub fn begin_popup_context_void(str_id: &str, flags: Option<ImGuiPopupFlags>) -> bool {
    cxx::let_cxx_string!(str_id = str_id);
    rimgui::BeginPopupContextVoid(&str_id, to_flag!(flags, ImGuiPopupFlags::MouseButtonRight))
}
...
pub fn table_next_column() -> bool {
    rimgui::TableNextColumn()
}

pub fn table_set_column_index(column_n: i32) -> bool {
    rimgui::TableSetColumnIndex(column_n)
}
...
pub fn table_setup_scroll_freeze(left_columns: i32, right_columns: i32) {
    rimgui::TableSetupScrollFreeze(left_columns, right_columns)
}

pub fn table_headers_row() {
    rimgui::TableHeadersRow()
}

pub fn table_header(label: &str) {
    cxx::let_cxx_string!(label = label);
    rimgui::TableHeader(&label)
}

pub fn table_get_sort_specs() -> *const ImGuiTableSortSpecs {
    rimgui::TableGetSortSpecs() as *const ImGuiTableSortSpecs
}

pub fn table_get_column_count() -> i32 {
    rimgui::TableGetColumnCount()
}

pub fn table_get_column_index() -> i32 {
    rimgui::TableGetColumnIndex()
}
